...
public class Sound {
    ...
    public Sound() {
        ...
        soundURL[8] = getClass().getResource("/sounds/eggcracking.wav");
        soundURL[9] = getClass().getResource("/sounds/trap.wav");
        soundURL[10] = getClass().getResource("/sounds/unlockgate.wav");
    }
